...
var QuestionSetService = (function () {
    ...
    QuestionSetService.prototype.getQuestionSets = function (company_id) {
        return this.http.get(api_url_component_1.ApiUrl.baseUrl + 'questionSet/' + company_id);
    };
    QuestionSetService.prototype.getQuestionSet = function (company_id, question_set_id) {
        return this.http.get(api_url_component_1.ApiUrl.baseUrl + 'questionSet/' + company_id + '/' + question_set_id);
    };
    QuestionSetService.prototype.saveQuestionSet = function (data) {
        return this.http.post(api_url_component_1.ApiUrl.baseUrl + 'saveQuestionSet', data);
    };
